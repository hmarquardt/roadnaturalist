...
export function buildCorridorBundle({ candidate, roads = [], ecology = null, habitat = null, occurrence = null, investigation = null,
  ...
  return Object.freeze({
    ...
    access: access ? Object.freeze({
      ...
      // How the sources were read, what changed at the source, and which earlier run this one replaced: all three
      // belong in a portable record, because a finding without them cannot be judged.
      retrievalModes: access.retrievalModes ? Object.freeze({ ...access.retrievalModes }) : null,
      previousRun: access.previousRun ? Object.freeze({ ...access.previousRun }) : null,
      driftSummary: access.driftSummary ? Object.freeze({ changed: access.driftSummary.changed, unavailable: access.driftSummary.unavailable ?? null,
        note: access.driftSummary.note ?? null, states: Object.freeze([...(access.driftSummary.states ?? [])].map(entry => Object.freeze({ ...entry }))) }) : null,
    ...
    investigation: investigation ? Object.freeze({
      ...
      transportFallback: investigation.transportFallback ? Object.freeze({ ...investigation.transportFallback }) : null,
      ...
      research: investigation.research ? Object.freeze({ probes: Object.freeze(investigation.research.probes.map(probe => Object.freeze({ probeId: probe.probeId, stage: probe.stage,
        ...
        retrievalMode: probe.searched?.retrievalMode ?? null, drift: probe.drift ? Object.freeze({ worker: probe.drift.worker ? Object.freeze({ ...probe.drift.worker, added: Object.freeze([...(probe.drift.worker.added ?? [])]), removed: Object.freeze([...(probe.drift.worker.removed ?? [])]) }) : null,
          recorded: probe.drift.recorded ? Object.freeze({ ...probe.drift.recorded, added: Object.freeze([...(probe.drift.recorded.added ?? [])]), removed: Object.freeze([...(probe.drift.recorded.removed ?? [])]) }) : null }) : null }))),
